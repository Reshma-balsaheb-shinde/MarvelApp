...
class FavouriteCharacterViewModelTest :  TestCase() {
    ...
    public override fun setUp() {
        ...
        viewModel = FavouriteCharacterViewModel(repository)
    }
    ...
    fun testInsertandGetFunc() {
        ...
        Truth.assertThat(results != null).isTrue()
    }
    @Test
    fun testInsertandDeleteFunc() {
        ...
        Truth.assertThat(resultDelete.contains(ResultList)).isFalse()
    }
}